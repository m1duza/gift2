      ...
      <div>
        ...
        <img
          ...
          />
            ...
            alt=""
            className="snow_flake6"
          />

          
          <p className='absolute_text_love_you'>I love you!</p>
      ...
      >&lt;3</div>
        ...
        <div className='footer_pop_up_main'  >
          ...
          <div className="common_block_for_text">
            ...
            <p className="modal_text3">пишу это в 31 декобря)</p>
            <p className="modal_text">Спасибо тебе огромное еще раз. Каждый день я все так же удевляюсь тебе), какая ты у меня хорошая, добрая, заботливая, и очень красивая))). Даже не то что удевляюсь, просто с каждым днем, хоть кто то скажет что может изменится в человеке за это время, а ты не только стала для меня еще более заботливая, красивая), очень очень милая), хоть ты и так была для меня все то что я перечислил, но суть не в этом, суть в том что я тебя больше люблю)))! Кто бы что не говорил, но любовь это очень хорошее понятие, да оно никак не трактуется, но для меня оно значит очень многое, то что мы пережили), я рад каждому мгновенью с тобой)). Помню как даже еле уснул в тот день когда мы познакомились, все думал, понравился ли я ей хоть чуть чуть).</p>
            <p className="modal_text">ладно не буду много томить, Люблю тебя Мария Николенко), и я хочу прожить с тобой всю жизнь))). Хорошо тебе отпраздновать любимая), надеюсь в следующем году я уже буду рядышком), целовать тебя при всех), и вместе все шутить). Целую любимая)&lt;3</p>
            </div>
